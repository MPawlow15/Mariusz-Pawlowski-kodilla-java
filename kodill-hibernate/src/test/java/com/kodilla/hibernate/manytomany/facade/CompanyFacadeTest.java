...
class CompanyFacadeTest {
    ...
    void testRetrieveCompaniesWithNamesContaining() {
        ...
        //Then
        try {
            assertEquals(7, companiesWithNamesContaining1.size());
            assertEquals(4, companiesWithNamesContaining2.size());
            assertEquals(3, companiesWithNamesContaining3.size());
        } finally {
            //CleanUp
    ...
    void testRetrieveEmployeesWithLastname() {
        ...
        //Then
        assertEquals(19, employeeList1.size());
        assertEquals(16, employeeList2.size());
